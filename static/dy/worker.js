...
(() => {
  ...
  var Ys = (e, t, i) =>
    t in e
      ? it(e, t, { enumerable: !0, configurable: !0, writable: !0, value: i })
      : (e[t] = i);
  var zi = ((e) =>
    typeof require < "u"
      ? require
  ...
  var Pt = ie((Hn, Ki) => {
    ...
    function Gi(e, t) {
      for (var i = "", r = 0, s = -1, a = 0, n, o = 0; o <= e.length; ++o) {
    ...
    var Ie = {
      ...
      join: function () {
        ...
        for (var t, i = 0; i < arguments.length; ++i) {
          var r = arguments[i];
          (pe(r), r.length > 0 && (t === void 0 ? (t = r) : (t += "/" + r)));
        }
      ...
      relative: function (t, i) {
        if (
          (pe(t),
          pe(i),
          t === i || ((t = Ie.resolve(t)), (i = Ie.resolve(i)), t === i))
        )
          return "";
        ...
        for (
          var o = i.length, u = o - n, h = a < u ? a : u, f = -1, p = 0;
          p <= h;
          ++p
        ) {
          if (p === h) {
            if (u > h) {
              if (i.charCodeAt(n + p) === 47) return i.slice(n + p + 1);
              if (p === 0) return i.slice(n + p);
            } else
              a > h &&
                (t.charCodeAt(r + p) === 47 ? (f = p) : p === 0 && (f = 0));
            break;
          }
      ...
      parse: function (t) {
        ...
        return (
          ...
          (p === 1 && n === u - 1 && n === o + 1)
            ...
            : (o === 0 && s
                ? ((i.name = t.slice(1, n)), (i.base = t.slice(1, u)))
                : ((i.name = t.slice(o, n)), (i.base = t.slice(o, u))),
              (i.ext = t.slice(n, u))),
  ...
  var es = ie((ii) => {
    ...
    function mn(e, t) {
      ...
      for (var i = {}, r = t || {}, s = r.decode || xn, a = 0; a < e.length; ) {
        var n = e.indexOf("=", a);
        if (n === -1) break;
        var o = e.indexOf(";", a);
        if (o === -1) o = e.length;
        ...
        if (i[u] === void 0) {
          ...
          (h.charCodeAt(0) === 34 && (h = h.slice(1, -1)), (i[u] = bn(h, s)));
        }
        a = o + 1;
      }
      return i;
    ...
    function gn(e, t, i) {
      ...
      var a = s(t);
      if (a && !gt.test(a)) throw new TypeError("argument val is invalid");
      var n = e + "=" + a;
      if (r.maxAge != null) {
        var o = r.maxAge - 0;
      ...
      if (r.domain) {
        if (!gt.test(r.domain)) throw new TypeError("option domain is invalid");
        n += "; Domain=" + r.domain;
      }
      if (r.path) {
        if (!gt.test(r.path)) throw new TypeError("option path is invalid");
        n += "; Path=" + r.path;
      }
      if (r.expires) {
        var u = r.expires;
  ...
  var is = ie((Jn, We) => {
    ...
    function ts(e, t) {
      if (((t = t ? Object.assign({}, De, t) : De), !e)) return t.map ? {} : [];
      if (e.headers)
    ...
    function _n(e) {
      ...
      for (; i < e.length; ) {
        for (r = i, o = !1; u(); )
          if (((s = e.charAt(i)), s === ",")) {
            for (a = i, i += 1, u(), n = i; i < e.length && h(); ) i += 1;
            i < e.length && e.charAt(i) === "="
              ? ((o = !0), (i = n), t.push(e.substring(r, a)), (r = i))
              : (i = a + 1);
          } else i += 1;
          ...
          var s = function () {
            ...
            u = (o.Base = (function () {
              return {
                ...
                init: function () {},
                mixIn: function (l) {
                  for (var d in l) l.hasOwnProperty(d) && (this[d] = l[d]);
            ...
            h = (o.WordArray = u.extend({
              ...
              concat: function (l) {
                ...
                if ((this.clamp(), v % 4))
                  for (var D = 0; D < L; D++) {
                    var O = (b[D >>> 2] >>> (24 - (D % 4) * 8)) & 255;
                    d[(v + D) >>> 2] |= O << (24 - ((v + D) % 4) * 8);
                  }
                else
                  for (var N = 0; N < L; N += 4) d[(v + N) >>> 2] = b[N >>> 2];
                return ((this.sigBytes += L), this);
              },
              clamp: function () {
                var l = this.words,
                  d = this.sigBytes;
                ((l[d >>> 2] &= 4294967295 << (32 - (d % 4) * 8)),
                  (l.length = t.ceil(d / 4)));
              },
              clone: function () {
              ...
              random: function (l) {
                for (var d = [], b = 0; b < l; b += 4) d.push(s());
            ...
            p = (f.Hex = {
              stringify: function (l) {
                for (
                  var d = l.words, b = l.sigBytes, v = [], L = 0;
                  L < b;
                  L++
                ) {
                  var D = (d[L >>> 2] >>> (24 - (L % 4) * 8)) & 255;
              ...
              parse: function (l) {
                for (var d = l.length, b = [], v = 0; v < d; v += 2)
                  b[v >>> 3] |=
                    parseInt(l.substr(v, 2), 16) << (24 - (v % 8) * 4);
            ...
            g = (f.Latin1 = {
              ...
              parse: function (l) {
                for (var d = l.length, b = [], v = 0; v < d; v++)
                  b[v >>> 2] |= (l.charCodeAt(v) & 255) << (24 - (v % 4) * 8);
            ...
            y = (f.Utf8 = {
              stringify: function (l) {
                try {
                  return decodeURIComponent(escape(g.stringify(l)));
                } catch {
            ...
            m = (o.BufferedBlockAlgorithm = u.extend({
              ...
              _process: function (l) {
                ...
                l
                  ? (N = t.ceil(N))
                  : (N = t.max((N | 0) - this._minBufferSize, 0));
                var H = N * D,
                  $ = t.min(H * 4, L);
                if (H) {
                  for (var x = 0; x < H; x += D) this._doProcessBlock(v, x);
            ...
            a = (s.Base64 = {
              stringify: function (o) {
                ...
                for (var p = [], g = 0; g < h; g += 3)
                  for (
                    var y = (u[g >>> 2] >>> (24 - (g % 4) * 8)) & 255,
                      m = (u[(g + 1) >>> 2] >>> (24 - ((g + 1) % 4) * 8)) & 255,
                      T = (u[(g + 2) >>> 2] >>> (24 - ((g + 2) % 4) * 8)) & 255,
                      I = (y << 16) | (m << 8) | T,
                      l = 0;
                    l < 4 && g + l * 0.75 < h;
                    l++
                  )
                    p.push(f.charAt((I >>> (6 * (3 - l))) & 63));
                var d = f.charAt(64);
              ...
              parse: function (o) {
                ...
                if (!f) {
                  f = this._reverseMap = [];
                  for (var p = 0; p < h.length; p++) f[h.charCodeAt(p)] = p;
                }
                var g = h.charAt(64);
                if (g) {
                  var y = o.indexOf(g);
          ...
          var u = (n.MD5 = a.extend({
            ...
            _doFinalize: function () {
              ...
              ((m[(((I + 64) >>> 9) << 4) + 15] =
                ...
                this._process());
              for (var b = this._hash, v = b.words, L = 0; L < 4; L++) {
                var D = v[L];
                v[L] =
                  (((D << 8) | (D >>> 24)) & 16711935) |
                  (((D << 24) | (D >>> 8)) & 4278255360);
              ...
              _doProcessBlock: function (u, h) {
                for (
                  ...
                  if (I < 16) n[I] = u[h + I] | 0;
                    ...
                    var l = n[I - 3] ^ n[I - 8] ^ n[I - 14] ^ n[I - 16];
                    n[I] = (l << 1) | (l >>> 31);
                  }
                  var d = ((p << 5) | (p >>> 27)) + T + n[I];
                  (I < 20
                    ? (d += ((g & y) | (~g & m)) + 1518500249)
                    : I < 40
                      ? (d += (g ^ y ^ m) + 1859775393)
                      : I < 60
                        ? (d += ((g & y) | (g & m) | (y & m)) - 1894007588)
                        : (d += (g ^ y ^ m) - 899497514),
                    (T = m),
                    (m = y),
                    (y = (g << 30) | (g >>> 2)),
      ...
      return (
        (function () {
          var t = e,
            ...
            n = a.MD5,
            o = (a.EvpKDF = r.extend({
              cfg: r.extend({ keySize: 128 / 32, hasher: n, iterations: 1 }),
              init: function (u) {
              ...
              compute: function (u, h) {
                for (
                  ...
                  for (var l = 1; l < I; l++) ((f = g.finalize(f)), g.reset());
                  y.concat(f);
                }
          ...
          var i = e,
            ...
            I = (m.CBC = (function () {
              ...
              function E(P, _, V) {
                var j,
                  z = this._iv;
                z ? ((j = z), (this._iv = t)) : (j = this._prevBlock);
              ...
              reset: function () {
                ...
                (this._xformMode == this._ENC_XFORM_MODE
                  ...
                  this._mode && this._mode.__creator == x
                    ...
                    : ((this._mode = x.call(_, this, P && P.words)),
            ...
            O = (r.SerializableCipher = s.extend({
              ...
              decrypt: function (x, E, P, _) {
                ((_ = this.cfg.extend(_)), (E = this._parse(E, _.format)));
                var V = x.createDecryptor(P, _).finalize(E.ciphertext);
                return V;
              },
              _parse: function (x, E) {
                return typeof x == "string" ? E.parse(x, this) : x;
              },
            })),
            N = (i.kdf = {}),
            H = (N.OpenSSL = {
              execute: function (x, E, P, _, V) {
                if ((_ || (_ = a.random(64 / 8)), V))
                  var j = p.create({ keySize: E + P, hasher: V }).compute(x, _);
                else var j = p.create({ keySize: E + P }).compute(x, _);
            ...
            $ = (r.PasswordBasedCipher = O.extend({
              ...
              encrypt: function (x, E, P, _) {
                _ = this.cfg.extend(_);
                var V = _.kdf.execute(P, x.keySize, x.ivSize, _.salt, _.hasher);
                _.iv = V.iv;
              ...
              decrypt: function (x, E, P, _) {
                ((_ = this.cfg.extend(_)), (E = this._parse(E, _.format)));
                var V = _.kdf.execute(P, x.keySize, x.ivSize, E.salt, _.hasher);
                _.iv = V.iv;
          ...
          (function () {
            ...
            for (var b = 0, v = 0, d = 0; d < 256; d++) {
              ...
              ((o[b] = (H << 24) | (H >>> 8)),
                ...
                (h[b] = (H << 8) | (H >>> 24)),
                (f[b] = H));
              var H = (N * 16843009) ^ (O * 65537) ^ (D * 257) ^ (b * 16843008);
              ((p[L] = (H << 24) | (H >>> 8)),
                (g[L] = (H << 16) | (H >>> 16)),
                (y[L] = (H << 8) | (H >>> 24)),
                (m[L] = H),
                b ? ((b = D ^ l[l[l[N ^ D]]]), (v ^= l[l[v]])) : (b = v = 1));
            }
          })();
          var T = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
            I = (s.AES = r.extend({
                      ...
                      : ((l = O[N - 1]),
                        N % v
                          ...
                          : ((l = (l << 8) | (l >>> 24)),
                            ...
                            (l ^= T[(N / v) | 0] << 24)),
                        (O[N] = O[N - v] ^ l));
                  for (var H = (this._invKeySchedule = []), $ = 0; $ < D; $++) {
                    var N = D - $;
                    if ($ % 4) var l = O[N];
                    else var l = O[N - 4];
                    $ < 4 || N <= 4
              ...
              encryptBlock: function (l, d) {
                this._doCryptBlock(l, d, this._keySchedule, o, u, h, f, a);
              },
        ...
        for (var n = 0; n < a.length; n++) {
          ...
          if (t[o]) {
            ...
            if (
              ...
              (u > h || (u === h && t[o].substr(0, 12) === "application/"))
            )
              continue;
          }
          t[o] = r;
  ...
  function aa() {
    return (
      Xi ||
      (Xi = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])
    );
  }
  function na() {
    return (
    ...
    return (
      r &&
        n.addEventListener("upgradeneeded", (u) => {
          r(se(n.result), u.oldVersion, u.newVersion, se(n.transaction), u);
        }),
      i &&
        n.addEventListener("blocked", (u) => i(u.oldVersion, u.newVersion, u)),
      o
        .then((u) => {
  ...
  function we(e) {
    return nr[e] || (nr[e] = new RegExp("^(?:" + e.replace(/ /g, "|") + ")$"));
  }
  function _e(e) {
    return e <= 65535
  ...
  var nt = 0,
    ...
    q = function (t, i, r) {
      ((this.options = t = ka(t)),
        ...
        (this.keywords = we(
          ga[t.ecmaVersion >= 6 ? 6 : t.sourceType === "module" ? "5module" : 5]
        )));
      var s = "";
      (t.allowReserved !== !0 &&
...
`,
    ...
    switch ((this.isLet(e) && ((r = c._var), (a = "let")), r)) {
      ...
      case c._import:
        ...
        return (
          ...
          r === c._import ? this.parseImport(s) : this.parseExport(s, i)
        );
      default:
        ...
        return r === c.name && f.type === "Identifier" && this.eat(c.colon)
        ...
        this.eat(c.eq)
          ...
          : !r &&
            ...
            : !r &&
                ...
                !(t && (this.type === c._in || this.isContextual("of")))
              ? this.raise(
                  this.lastTokEnd,
  ...
  R.parseFunction = function (e, t, i, r, s) {
    (this.initFunction(e),
      ...
      t & Ve &&
        ((e.id = t & Cr && this.type !== c.name ? null : this.parseIdent()),
        e.id &&
          !(t & Ut) &&
    ...
    return (
      ...
      this.finishNode(e, t & Ve ? "FunctionDeclaration" : "FunctionExpression")
    );
  };
  ...
  R.parseClassStaticBlock = function (e) {
    e.body = [];
    var t = this.labels;
    for (this.labels = [], this.enterScope(Ue | Wt); this.type !== c.braceR; ) {
  ...
  R.parseClassId = function (e, t) {
    this.type === c.name
      ? ((e.id = this.parseIdent()), t && this.checkLValSimple(e.id, ye, !1))
  ...
  le.parseBindingList = function (e, t, i, r) {
    for (var s = [], a = !0; !this.eat(e); )
      if ((a ? (a = !1) : this.expect(c.comma), t && this.type === c.comma))
        s.push(null);
      else {
  ...
  c._function.updateContext = c._class.updateContext = function (e) {
    ...
    !(
      e === c._return && ue.test(this.input.slice(this.lastTokEnd, this.start))
    ) &&
  ...
  B.parseMaybeAssign = function (e, t, i) {
    ...
    if ((i && (h = i.call(this, h, o, u)), this.type.isAssign)) {
      ...
      return (
        ...
        this.type === c.eq ? this.checkLValPattern(h) : this.checkLValSimple(h),
        (f.left = h),
        this.next(),
  ...
  B.parseExprOp = function (e, t, i, r, s) {
    ...
    if (a != null && (!s || this.type !== c._in) && a > r) {
      ...
      var h = this.start,
        f = this.startLoc,
        p = this.parseExprOp(this.parseMaybeUnary(null, !1, !1, s), h, f, a, s),
        ...
        u
          ...
          : this.strict &&
            ...
            : o.operator === "delete" && kr(o.argument)
              ...
              : (t = !0),
        (n = this.finishNode(o, u ? "UpdateExpression" : "UnaryExpression")));
    ...
    for (
      ...
      if (
        ...
        if (n) {
          ...
          ((u.expression = o), (o = this.finishNode(u, "ChainExpression")));
        }
        return o;
      }
      e = o;
  ...
  B.parseSubscript = function (e, t, i, r, s, a, n) {
    ...
    if (
      ...
      ((f.object = e),
        h
          ? ((f.property = this.parseExpression()), this.expect(c.bracketR))
          ...
          if (
            ...
            return (
              ...
              (this.canInsertSemicolon() || !this.eat(c.arrow)) &&
                this.unexpected(),
              this.parseArrowExpression(this.startNodeAt(a, n), [u], !0, t)
            );
        }
        return u;
      case c.regexp:
...
`
  ...
  B.parsePrivateIdent = function () {
    var e = this.startNode();
    return (
      this.type === c.privateId ? (e.name = this.value) : this.unexpected(),
      this.next(),
  ...
  Ce.declareName = function (e, t, i) {
    ...
    if (t === ye) {
      ...
      ((r =
        ...
        s.var.indexOf(e) > -1),
        s.lexical.push(e),
        this.inModule && s.flags & Fe && delete this.undefinedExports[e]);
    } else if (t === wr) {
      ...
      for (var o = this.scopeStack.length - 1; o >= 0; --o) {
        ...
        if (
          (u.var.push(e),
          this.inModule && u.flags & Fe && delete this.undefinedExports[e],
          u.flags & zt)
        )
          break;
      }
  ...
  var Er =
    ...
    Br =
      Tr + " Cypro_Minoan Cpmn Old_Uyghur Ougr Tangsa Tnsa Toto Vithkuqi Vith",
    Oa = Br + " Hrkt Katakana_Or_Hiragana Kawi Nag_Mundari Nagm Unknown Zzzz",
    ...
    me = function (t) {
      ((this.parser = t),
        ...
        (this.unicodeProperties =
          Or[t.options.ecmaVersion >= 14 ? 14 : t.options.ecmaVersion]),
        (this.source = ""),
        (this.flags = ""),
        (this.start = 0),
        (this.switchU = !1),
      ...
      if (this.regexp_eatFixedHexDigits(e, 4)) {
        ...
        if (r && s >= 55296 && s <= 56319) {
          ...
          if (e.eat(92) && e.eat(117) && this.regexp_eatFixedHexDigits(e, 4)) {
            ...
            if (n >= 56320 && n <= 57343)
              return (
                (e.lastIntValue = (s - 55296) * 1024 + (n - 56320) + 65536),
                !0
              );
          }
  ...
  A.regexp_eatUnicodePropertyValueExpression = function (e) {
    ...
    if (this.regexp_eatUnicodePropertyName(e) && e.eat(61)) {
      ...
      if (this.regexp_eatUnicodePropertyValue(e)) {
        ...
        return (this.regexp_validateUnicodePropertyNameAndValue(e, i, r), xe);
      }
    }
  ...
  var Qt = function (t) {
      ((this.type = t.type),
        ...
        (this.start = t.start),
        (this.end = t.end),
        t.options.locations && (this.loc = new ut(t, t.startLoc, t.endLoc)),
  ...
  M.skipBlockComment = function () {
    ...
    if (
      ...
      for (var r = void 0, s = t; (r = fr(this.input, s, this.pos)) > -1; )
  ...
  M.readToken_mult_modulo_exp = function (e) {
    ...
    return (
      this.options.ecmaVersion >= 7 &&
        e === 42 &&
        t === 42 &&
        (++i, (r = c.starstar), (t = this.input.charCodeAt(this.pos + 2))),
        ...
        let o = new ke(this.ws),
          ...
          f = (p) => {
            ...
            (p.stopImmediatePropagation(),
              a({ protocol: g.protocol, setCookies: g.setCookies }),
              n(Ee.OPEN),
    ...
    $e = class {
      ...
      createWebSocket(t, i = [], r) {
        ...
        let s = this.client.connect(
            ...
            async () => {
              let f =
                  typeof r.headers == "function"
                    ? await r.headers()
                    : r.headers || {},
                p = f instanceof Headers ? Object.fromEntries(f) : f;
              return (
                (p.Host = t.host),
                (p.Pragma = "no-cache"),
            ...
            (f) => {
              ((a = f.protocol),
                r.setCookiesCallback && r.setCookiesCallback(f.setCookies));
            },
            (f) => {
              n = f;
            },
      ...
      async fetch(t, i) {
        ...
        for (let f = 0; ; f++) {
          ...
          let p = await h.request(r.method, a, o, u, r.cache, n, r.signal);
  ...
  var rs,
    ...
    An = {
      Program(e, t) {
        ...
        s && e.trailingComments != null && X(t, e.trailingComments, i, r);
      },
      BlockStatement: (cs = function (e, t) {
        ...
        if (n != null && n.length > 0) {
          (t.write(r), s && e.comments != null && X(t, e.comments, a, r));
          let { length: o } = n;
          for (let u = 0; u < o; u++) {
            let h = n[u];
        ...
        (s && e.trailingComments != null && X(t, e.trailingComments, a, r),
          t.write("}"),
          t.indentLevel--);
      }),
      ClassBody: cs,
        ...
        if ((t.write("{"), e.properties.length > 0)) {
          ...
          s
            ? e.comments != null
              ? (t.write(r),
                X(t, e.comments, a, r),
                e.trailingComments != null && X(t, e.trailingComments, a, r),
                t.write(i + "}"))
              : e.trailingComments != null
                ? (t.write(r), X(t, e.trailingComments, a, r), t.write(i + "}"))
                : t.write("}")
            : t.write("}");
        t.indentLevel--;
      },
      ...
      NewExpression(e, t) {
        ...
        (i === fe || i < t.expressionsPrecedence.CallExpression || En(e.callee)
    ...
    constructor(t) {
      ...
      ((this.output = ""),
        ...
        (this.expressionsPrecedence =
          i.expressionsPrecedence != null ? i.expressionsPrecedence : kn),
...
self.document?.currentScript?.remove();`,
          ...
          for (var { name: a, value: n, expires: o } of s) {
            if (o) {
              ...
              if (u <= new Date()) {
                ve.remove(
                  e,
                  s.find((h) => h.name == a && h.value == n && h.expires == o),
                  t
                );
                continue;
              }
            ...
            r.find((h) => h.name == a && h.value == n) ||
              r.push({ name: a, value: n, expires: o || new Date(1e13) });
          }
      }
      return r;
    },
  ...
  var $i = Ae(js(), 1),
    ...
    Mn = {
      encode: (e) => e && $i.default.encrypt(e, $s).toString().substring(10),
      decode: (e) =>
        e && $i.default.decrypt("U2FsdGVkX1" + e, $s).toString(Ws.default),
    },
    ...
    (e.skipWaiting(),
      e.addEventListener("install", async (r, s) => {
        ...
        for await (var n of [["html", "dynamic.html.js"]]) {
          ...
          ((u = new URL(
            ...
            (e[o] = fetch(u)
              .then(
                (f) => (
                  a > 1 && console.log("Loaded Dynamic Module: " + o, f),
                  (e[o] = f.text())
                )
              )
              .then((f) => (0, eval)(f))),
        ...
        for await (var n of Object.values(e.__dynamic$config.assets.files)) {
          ...
          let g = await fetch(u);
          (await h.put(u, g),
            a > 1 && console.log("Cache Installed: " + u.split("/").pop(), g));
        }
        ...
        async fetch(r) {
          ...
          try {
            ...
            if (
              ...
              return (
                u.meta.load(new URL(v.headers.get("x-dynamic-location"))),
                u.is.html(u.meta, v.headers.get("content-type"), D)
                  ? (a = new Blob([u.rewrite.html.rewrite(D, u.meta, O)]))
                  : (a = L),
                new Response(a, {
                  status: v.status,
            ...
            if (
              ...
              i.indexOf(u.meta.host) !== -1 ||
                i.find((b) => b instanceof RegExp && b.test(u.meta.host)))
            )
              return (
            ...
            let p = Object.fromEntries(s.headers.entries()),
              g = t.util.reqHeader(
                ...
                s,
                await f.get(
                  s.client ? s.client.__dynamic$location.host : u.meta.host
                )
              ),
            ...
            (t.headers.method.body.indexOf(s.method.toUpperCase()) == -1 &&
              ...
              u.meta.protocol !== "about:"
                ? (m = await (await t.bare).fetch(u.meta.href, y.init))
                : (m = new t.util.about(
            ...
            switch (s.destination) {
              case "document":
                ...
                u.is.html(u.meta, m.headers.get("content-type"), v)
                  ? (l = new Blob([u.rewrite.html.rewrite(v, u.meta, L)], {
                      type:
              ...
              case "iframe": {
                let D = await m.blob(),
                  O = await D.text();
                if (u.is.html(u.meta, m.headers.get("content-type"), O)) {
                  try {
                    ...
                    l = new Blob(
                      [new (await e.html)({ ctx: u }).rewrite(O, u.meta, N)],
                      {
                        type:
                          m.headers.get("content-type") ||
                          "text/html; charset=utf-8",
              ...
              case "worker":
              case "script":
                u.is.js(u.meta, m.headers.get("content-type")) &&
                  (l = new Blob(
                    [u.rewrite.js.rewrite(await m.text(), s, !0, u)],
                    {
                      type:
                        m.headers.get("content-type") ||
                        "application/javascript",
                ...
                break;
              case "style":
                u.is.css(u.meta, m.headers.get("content-type")) &&
                  (l = new Blob(
                    [u.rewrite.css.rewrite(await m.text(), u.meta)],
                    { type: m.headers.get("content-type") || "text/css" }
                  ));
                break;
              case "manifest":
                l = new Blob([u.rewrite.man.rewrite(await m.text(), u.meta)], {
                  type: m.headers.get("content-type") || "application/json",
                });
                break;
              default: {
                let D = await m.blob(),
                ...
                if (u.is.html(u.meta, m.headers.get("content-type"), O)) {
                  try {
                    l = new Blob(
                      [new (await e.html)({ ctx: u }).rewrite(O, u.meta, [])],
                      {
                        type:
                          m.headers.get("content-type") ||
                          "text/html; charset=utf-8",
            ...
            (l == !1 && (l = await m.blob()),
              t.headers.status.empty.indexOf(m.status) !== -1 && (l = null),
            ...
            return (
              e.__dynamic$config.logLevel >= 1 && console.error(u),
              new Response(u, {
                status: 500,
                statusText: "error",
                headers: new Headers({}),
