...
(() => {
  ...
  var ie = (e, t) => () => (
    ...
    gr = (e, t) => {
      for (var i in t) nt(e, i, { get: t[i], enumerable: !0 });
    },
    Ca = (e, t, i, r) => {
  ...
  var Ae = (e, t, i) => (
    ...
    Ca(
      t || !e || !e.__esModule
        ? nt(i, "default", { value: e, enumerable: !0 })
        : i,
      e
    )
  );
    ...
    var Le = {
      ...
      join: function () {
        ...
        for (var t, i = 0; i < arguments.length; ++i) {
          var r = arguments[i];
          (fe(r), r.length > 0 && (t === void 0 ? (t = r) : (t += "/" + r)));
        }
      ...
      relative: function (t, i) {
        if (
          (fe(t),
          fe(i),
          t === i || ((t = Le.resolve(t)), (i = Le.resolve(i)), t === i))
        )
          return "";
  ...
  var kn = ie((pi) => {
    ...
    function js(e, t) {
      ...
      for (var i = {}, r = t || {}, n = r.decode || Us, a = 0; a < e.length; ) {
        var s = e.indexOf("=", a);
        if (s === -1) break;
        var o = e.indexOf(";", a);
        if (o === -1) o = e.length;
        ...
        if (i[c] === void 0) {
          ...
          (l.charCodeAt(0) === 34 && (l = l.slice(1, -1)), (i[c] = zs(l, n)));
        }
        a = o + 1;
      }
      return i;
    ...
    function Hs(e, t, i) {
      ...
      if (!xt.test(e)) throw new TypeError("argument name is invalid");
      var a = n(t);
      if (a && !xt.test(a)) throw new TypeError("argument val is invalid");
      var s = e + "=" + a;
      if (r.maxAge != null) {
        var o = r.maxAge - 0;
      ...
      if (r.domain) {
        if (!xt.test(r.domain)) throw new TypeError("option domain is invalid");
        s += "; Domain=" + r.domain;
      }
      if (r.path) {
        if (!xt.test(r.path)) throw new TypeError("option path is invalid");
        s += "; Path=" + r.path;
      }
      if (r.expires) {
        var c = r.expires;
  ...
  var Ln = ie((ko, qe) => {
    ...
    function An(e, t) {
      if (((t = t ? Object.assign({}, Ne, t) : Ne), !e)) return t.map ? {} : [];
      if (e.headers)
      ...
      if (
        ...
        var r = {};
        return e.filter(fi).reduce(function (n, a) {
          var s = di(a, t);
          return ((n[s.name] = s), n);
        }, r);
      } else
        return e.filter(fi).map(function (n) {
          return di(n, t);
        });
    }
    function Ks(e) {
    ...
    qe.exports = An;
    qe.exports.parse = An;
    qe.exports.parseString = di;
    qe.exports.splitCookiesString = Ks;
  });
  var Jn = ie(() => {});
  var ve = ie((Rt, Zn) => {
    (function (e, t) {
          ...
          var n = function () {
            ...
            c = (o.Base = (function () {
              return {
                ...
                init: function () {},
                mixIn: function (p) {
                  for (var d in p) p.hasOwnProperty(d) && (this[d] = p[d]);
            ...
            l = (o.WordArray = c.extend({
              ...
              concat: function (p) {
                ...
                if ((this.clamp(), k % 4))
                  for (var M = 0; M < T; M++) {
                    var H = (E[M >>> 2] >>> (24 - (M % 4) * 8)) & 255;
                    d[(k + M) >>> 2] |= H << (24 - ((k + M) % 4) * 8);
                  }
                else
                  for (var I = 0; I < T; I += 4) d[(k + I) >>> 2] = E[I >>> 2];
                return ((this.sigBytes += T), this);
              },
              clamp: function () {
                var p = this.words,
                  d = this.sigBytes;
                ((p[d >>> 2] &= 4294967295 << (32 - (d % 4) * 8)),
                  (p.length = t.ceil(d / 4)));
              },
              clone: function () {
              ...
              random: function (p) {
                for (var d = [], E = 0; E < p; E += 4) d.push(n());
            ...
            f = (h.Hex = {
              stringify: function (p) {
                for (
                  var d = p.words, E = p.sigBytes, k = [], T = 0;
                  T < E;
                  T++
                ) {
                  var M = (d[T >>> 2] >>> (24 - (T % 4) * 8)) & 255;
              ...
              parse: function (p) {
                for (var d = p.length, E = [], k = 0; k < d; k += 2)
                  E[k >>> 3] |=
                    parseInt(p.substr(k, 2), 16) << (24 - (k % 8) * 4);
            ...
            m = (h.Latin1 = {
              ...
              parse: function (p) {
                for (var d = p.length, E = [], k = 0; k < d; k++)
                  E[k >>> 2] |= (p.charCodeAt(k) & 255) << (24 - (k % 4) * 8);
            ...
            x = (o.BufferedBlockAlgorithm = c.extend({
              ...
              _process: function (p) {
                ...
                p
                  ? (I = t.ceil(I))
                  : (I = t.max((I | 0) - this._minBufferSize, 0));
                var j = I * M,
                  U = t.min(j * 4, T);
                if (j) {
                  for (var y = 0; y < j; y += M) this._doProcessBlock(k, y);
                ...
                for (var f = [], m = 0; m < l; m += 3)
                  for (
                    var g = (c[m >>> 2] >>> (24 - (m % 4) * 8)) & 255,
                      x = (c[(m + 1) >>> 2] >>> (24 - ((m + 1) % 4) * 8)) & 255,
                      D = (c[(m + 2) >>> 2] >>> (24 - ((m + 2) % 4) * 8)) & 255,
                      R = (g << 16) | (x << 8) | D,
                      p = 0;
                    p < 4 && m + p * 0.75 < l;
                    p++
                  )
                    f.push(h.charAt((R >>> (6 * (3 - p))) & 63));
                var d = h.charAt(64);
          ...
          var c = (s.MD5 = a.extend({
            ...
            _doFinalize: function () {
              ...
              ((x[(((R + 64) >>> 9) << 4) + 15] =
                ...
                this._process());
              for (var E = this._hash, k = E.words, T = 0; T < 4; T++) {
                var M = k[T];
                k[T] =
                  (((M << 8) | (M >>> 24)) & 16711935) |
                  (((M << 24) | (M >>> 8)) & 4278255360);
              ...
              _doProcessBlock: function (c, l) {
                for (
                  ...
                  if (R < 16) s[R] = c[l + R] | 0;
                    ...
                    var p = s[R - 3] ^ s[R - 8] ^ s[R - 14] ^ s[R - 16];
                    s[R] = (p << 1) | (p >>> 31);
                  }
                  var d = ((f << 5) | (f >>> 27)) + D + s[R];
                  (R < 20
                    ? (d += ((m & g) | (~m & x)) + 1518500249)
                    : R < 40
                      ? (d += (m ^ g ^ x) + 1859775393)
                      : R < 60
                        ? (d += ((m & g) | (m & x) | (g & x)) - 1894007588)
                        : (d += (m ^ g ^ x) - 899497514),
                    (D = x),
                    (x = g),
                    (g = (m << 30) | (m >>> 2)),
      ...
      return (
        (function () {
          var t = e,
            ...
            s = a.MD5,
            o = (a.EvpKDF = r.extend({
              cfg: r.extend({ keySize: 128 / 32, hasher: s, iterations: 1 }),
              init: function (c) {
              ...
              compute: function (c, l) {
                for (
                  ...
                  (h && m.update(h), (h = m.update(c).finalize(l)), m.reset());
                  for (var p = 1; p < R; p++) ((h = m.finalize(h)), m.reset());
                  g.concat(h);
                }
          ...
          var i = e,
            ...
            R = (x.CBC = (function () {
              ...
              function C(L, v, O) {
                var V,
                  q = this._iv;
                q ? ((V = q), (this._iv = t)) : (V = this._prevBlock);
              ...
              reset: function () {
                ...
                (this._xformMode == this._ENC_XFORM_MODE
                  ...
                  this._mode && this._mode.__creator == y
                    ...
                    : ((this._mode = y.call(v, this, L && L.words)),
            ...
            H = (r.SerializableCipher = n.extend({
              ...
              decrypt: function (y, C, L, v) {
                ((v = this.cfg.extend(v)), (C = this._parse(C, v.format)));
                var O = y.createDecryptor(L, v).finalize(C.ciphertext);
                return O;
              },
              _parse: function (y, C) {
            ...
            j = (I.OpenSSL = {
              execute: function (y, C, L, v, O) {
                if ((v || (v = a.random(64 / 8)), O))
                  var V = f.create({ keySize: C + L, hasher: O }).compute(y, v);
                else var V = f.create({ keySize: C + L }).compute(y, v);
            ...
            U = (r.PasswordBasedCipher = H.extend({
              ...
              encrypt: function (y, C, L, v) {
                v = this.cfg.extend(v);
                var O = v.kdf.execute(L, y.keySize, y.ivSize, v.salt, v.hasher);
                v.iv = O.iv;
              ...
              decrypt: function (y, C, L, v) {
                ((v = this.cfg.extend(v)), (C = this._parse(C, v.format)));
                var O = v.kdf.execute(L, y.keySize, y.ivSize, C.salt, v.hasher);
                v.iv = O.iv;
  ...
  var pa = ie((Bt, ha) => {
    (function (e, t, i) {
      typeof Bt == "object"
        ? (ha.exports = Bt = t(ve(), ta(), ra(), fr(), la()))
        : typeof define == "function" && define.amd
          ? define(
          ...
          (function () {
            ...
            for (var E = 0, k = 0, d = 0; d < 256; d++) {
              ...
              ((o[E] = (j << 24) | (j >>> 8)),
                ...
                (l[E] = (j << 8) | (j >>> 24)),
                (h[E] = j));
              var j = (I * 16843009) ^ (H * 65537) ^ (M * 257) ^ (E * 16843008);
              ((f[T] = (j << 24) | (j >>> 8)),
                (m[T] = (j << 16) | (j >>> 16)),
                (g[T] = (j << 8) | (j >>> 24)),
                (x[T] = j),
                E ? ((E = M ^ p[p[p[I ^ M]]]), (k ^= p[p[k]])) : (E = k = 1));
            }
          })();
          var D = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
            R = (n.AES = r.extend({
                      ...
                      : ((p = H[I - 1]),
                        I % k
                          ...
                          : ((p = (p << 8) | (p >>> 24)),
                            ...
                            (p ^= D[(I / k) | 0] << 24)),
                        (H[I] = H[I - k] ^ p));
                  for (var j = (this._invKeySchedule = []), U = 0; U < M; U++) {
                    var I = M - U;
                    if (U % 4) var p = H[I];
                    else var p = H[I - 4];
                    U < 4 || I <= 4
              ...
              encryptBlock: function (p, d) {
                this._doCryptBlock(p, d, this._keySchedule, o, c, l, h, a);
              },
  ...
  function Ta() {
    return (
      Cr ||
      (Cr = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])
    );
  }
  function Na() {
    return (
  ...
  function Da(e) {
    ...
    return (
      t
        .then((i) => {
          i instanceof IDBCursor && kr.set(i, e);
        })
        .catch(() => {}),
      Ut.set(t, e),
      t
  ...
  var Ht = {
    get(e, t, i) {
      if (e instanceof IDBTransaction) {
        if (t === "done") return jt.get(e);
        if (t === "objectStoreNames") return e.objectStoreNames || Ar.get(e);
        if (t === "store")
  ...
  function Oa(e) {
    return e === IDBDatabase.prototype.transaction &&
      ...
      ? function (t, ...i) {
          let r = e.call(Be(this), t, ...i);
          return (Ar.set(r, t.sort ? t.sort() : [t]), ne(r));
        }
      : Na().includes(e)
        ? function (...t) {
            return (e.apply(Be(this), t), ne(kr.get(this)));
          }
        : function (...t) {
            return ne(e.apply(Be(this), t));
          };
  }
  function Ba(e) {
    return typeof e == "function"
      ...
      : (e instanceof IDBTransaction && Ma(e),
        Ia(e, Ta()) ? new Proxy(e, Ht) : e);
  }
  function ne(e) {
    if (e instanceof IDBRequest) return Da(e);
    if ($t.has(e)) return $t.get(e);
    let t = Ba(e);
    return (t !== e && ($t.set(e, t), Ut.set(t, e)), t);
  }
  var Be = (e) => Ut.get(e);
  function qt(
    e,
    ...
    return (
      r &&
        s.addEventListener("upgradeneeded", (c) => {
          r(ne(s.result), c.oldVersion, c.newVersion, ne(s.transaction), c);
        }),
      i &&
  ...
  Lr((e) => ({
    ...e,
    get: (t, i, r) => Pr(t, i) || e.get(t, i, r),
    has: (t, i) => !!Pr(t, i) || e.has(t, i),
  }));
  var ja = [
  ...
  var se = { beforeExpr: !0 },
    ...
    Jt = {};
  function F(e, t) {
    return (t === void 0 && (t = {}), (t.keyword = e), (Jt[e] = new $(e, t)));
  }
  var u = {
      num: new $("num", te),
  ...
  function be(e) {
    return Ir[e] || (Ir[e] = new RegExp("^(?:" + e.replace(/ /g, "|") + ")$"));
  }
  function we(e) {
    return e <= 65535
  ...
  Ve.prototype.offset = function (t) {
    return new Ve(this.line, this.column + t);
  };
  ...
  function Xa(e) {
    var t = {};
    for (var i in Yt) t[i] = e && je(e, i) ? e[i] : Yt[i];
    if (
...
Defaulting to 2020, but this will stop working in the future.`)),
    ...
    return (Rr(t.onComment) && (t.onComment = Ja(t, t.onComment)), t);
  }
  function Ja(e, t) {
    return function (i, r, n, a, s, o) {
      var c = { type: i ? "Block" : "Line", value: r, start: n, end: a };
      (e.locations && (c.loc = new ht(this, s, o)),
  ...
  var ct = 0,
    ...
    z = function (t, i, r) {
      ((this.options = t = Xa(t)),
        ...
        (this.keywords = be(
          Ua[t.ecmaVersion >= 6 ? 6 : t.sourceType === "module" ? "5module" : 5]
        )));
      var n = "";
      (t.allowReserved !== !0 &&
        ((n = zt[t.ecmaVersion >= 6 ? 6 : t.ecmaVersion === 5 ? 5 : 3]),
        t.sourceType === "module" && (n += " await")),
        (this.reservedWords = be(n)));
      var a = (n ? n + " " : "") + zt.strict;
      ((this.reservedWordsStrict = be(a)),
        (this.reservedWordsStrictBind = be(a + " " + zt.strictBind)),
        (this.input = String(i)),
        (this.containsEsc = !1),
        r
          ? ((this.pos = r),
...
`,
  ...
  de.inGenerator.get = function () {
    return (
      (this.currentVarScope().flags & jr) > 0 &&
  ...
  de.canAwait.get = function () {
    for (var e = this.scopeStack.length - 1; e >= 0; e--) {
      ...
      if (t.inClassFieldInit || t.flags & He) return !1;
      if (t.flags & Ie) return (t.flags & Zt) > 0;
    }
    return (
  ...
  de.allowSuper.get = function () {
    ...
    return (t & ei) > 0 || i || this.options.allowSuperOutsideMethod;
  };
  de.allowDirectSuper.get = function () {
    return (this.currentThisScope().flags & Wr) > 0;
  };
  ...
  P.isAsyncFunction = function () {
    ...
    return (
      ...
      (t + 8 === this.input.length ||
        !(Pe((i = this.input.charCodeAt(t + 8))) || (i > 55295 && i < 56320)))
    );
  };
  ...
  P.parseFunctionStatement = function (e, t, i) {
    return (this.next(), this.parseFunction(e, Fe | (i ? 0 : Xt), !1, t));
  };
  ...
  P.parseCatchClauseParam = function () {
    var e = this.parseBindingAtom(),
      t = e.type === "Identifier";
    return (
      this.enterScope(t ? Ur : 0),
      this.checkLValPattern(e, t ? zr : xe),
  ...
  P.parseVarId = function (e, t) {
    ((e.id = this.parseBindingAtom()),
      this.checkLValPattern(e.id, t === "var" ? ri : xe, !1));
  };
  var Fe = 1,
    Xt = 2,
    Kr = 4;
  P.parseFunction = function (e, t, i, r, n) {
    (this.initFunction(e),
      (this.options.ecmaVersion >= 9 ||
        ...
        (this.type === u.star && t & Xt && this.unexpected(),
        (e.generator = this.eat(u.star))),
      this.options.ecmaVersion >= 8 && (e.async = !!r),
      t & Fe &&
        ((e.id = t & Kr && this.type !== u.name ? null : this.parseIdent()),
        e.id &&
          !(t & Xt) &&
    ...
    return (
      ...
      this.enterScope(ii(e.async, e.generator)),
      t & Fe || (e.id = this.type === u.name ? this.parseIdent() : null),
      this.parseFunctionParams(e),
      this.parseFunctionBody(e, i, !1, n),
      (this.yieldPos = a),
      (this.awaitPos = s),
      (this.awaitIdentPos = o),
      this.finishNode(e, t & Fe ? "FunctionDeclaration" : "FunctionExpression")
    );
  };
  ...
  P.parseClassElement = function (e) {
    ...
    if (
      ...
      var l = !i.static && ut(i, "constructor"),
        h = l && e;
      (l &&
        s !== "method" &&
  ...
  P.parseClassStaticBlock = function (e) {
    e.body = [];
    var t = this.labels;
    for (this.labels = [], this.enterScope(He | ei); this.type !== u.braceR; ) {
  ...
  P.parseClassId = function (e, t) {
    this.type === u.name
      ? ((e.id = this.parseIdent()), t && this.checkLValSimple(e.id, xe, !1))
  ...
  P.parseExportDefaultDeclaration = function () {
    ...
    if (this.type === u._function || (e = this.isAsyncFunction())) {
      ...
      return (
        this.next(),
        e && this.next(),
        this.parseFunction(t, Fe | Kr, !1, e)
      );
  ...
  P.checkExport = function (e, t, i) {
    e &&
      ...
      je(e, t) && this.raiseRecoverable(i, "Duplicate export '" + t + "'"),
      (e[t] = !0));
  };
        ...
        (this.strict &&
          ...
          r &&
            ...
            i &&
              ...
              (i[e.name] = !0)),
            t !== Gr && this.declareName(e.name, t, e.start)));
        break;
      case "ChainExpression":
        this.raiseRecoverable(
          e.start,
  ...
  u._function.updateContext = u._class.updateContext = function (e) {
    ...
    !(
      e === u._return && ue.test(this.input.slice(this.lastTokEnd, this.start))
    ) &&
...
`
  ...
  N.parseMethod = function (e, t, i) {
    ...
    return (
      ...
      (this.awaitPos = 0),
      (this.awaitIdentPos = 0),
      this.enterScope(ii(t, r.generator) | ei | (i ? Wr : 0)),
      this.expect(u.parenL),
  ...
  N.parseFunctionBody = function (e, t, i, r) {
    ...
    if (n)
      ...
      ((this.labels = []),
        ...
        this.strict && e.id && this.checkLValSimple(e.id, Gr),
  ...
  N.checkParams = function (e, t) {
    for (
      ...
      var a = n[r];
      this.checkLValInnerPattern(a, ri, t ? null : i);
    }
  };
  ...
  lt.curPosition = function () {
    if (this.options.locations)
      return new Ve(this.curLine, this.pos - this.lineStart);
  };
  var Se = z.prototype,
    ns = function (t) {
      ((this.flags = t),
  ...
  Se.declareName = function (e, t, i) {
    ...
    if (t === xe) {
      ...
      ((r =
        ...
        n.var.indexOf(e) > -1),
        n.lexical.push(e),
        this.inModule && n.flags & $e && delete this.undefinedExports[e]);
    } else if (t === zr) {
      ...
      for (var o = this.scopeStack.length - 1; o >= 0; --o) {
        ...
        if (
          (c.var.push(e),
          this.inModule && c.flags & $e && delete this.undefinedExports[e],
          c.flags & ti)
        )
          break;
      }
  ...
  Se.currentVarScope = function () {
    for (var e = this.scopeStack.length - 1; ; e--) {
      var t = this.scopeStack[e];
      if (t.flags & ti) return t;
    }
  };
  Se.currentThisScope = function () {
    for (var e = this.scopeStack.length - 1; ; e--) {
      var t = this.scopeStack[e];
      if (t.flags & ti && !(t.flags & Hr)) return t;
    }
  };
  var ft = function (t, i, r) {
      ((this.type = ""),
        (this.start = i),
        (this.end = 0),
        t.options.locations && (this.loc = new ht(t, r)),
  ...
  Ue.finishNodeAt = function (e, t, i, r) {
    return Yr.call(this, e, t, i, r);
  };
  ...
  var Xr =
    ...
    Jr = Xr + " Extended_Pictographic",
    Zr = Jr,
    en = Zr + " EBase EComp EMod EPres ExtPict",
    tn = en,
    as = tn,
    ss = { 9: Xr, 10: Jr, 11: Zr, 12: en, 13: tn, 14: as },
    os =
    ...
    on =
      sn + " Cypro_Minoan Cpmn Old_Uyghur Ougr Tangsa Tnsa Toto Vithkuqi Vith",
    us = on + " Hrkt Katakana_Or_Hiragana Kawi Nag_Mundari Nagm Unknown Zzzz",
    ls = { 9: rn, 10: nn, 11: an, 12: sn, 13: on, 14: us },
    cn = {};
  function hs(e) {
    var t = (cn[e] = {
      binary: be(ss[e] + " " + Nr),
      binaryOfStrings: be(cs[e]),
      nonBinary: { General_Category: be(Nr), Script: be(ls[e]) },
    });
  ...
  for (ot = 0, Kt = [9, 10, 11, 12, 13, 14]; ot < Kt.length; ot += 1)
    ((Dr = Kt[ot]), hs(Dr));
  var Dr,
    ot,
    Kt,
    ...
    me = function (t) {
      ((this.parser = t),
        ...
        (this.unicodeProperties =
          cn[t.options.ecmaVersion >= 14 ? 14 : t.options.ecmaVersion]),
        (this.source = ""),
        (this.flags = ""),
        (this.start = 0),
        (this.switchU = !1),
  ...
  A.regexp_eatSyntaxCharacter = function (e) {
    var t = e.current();
    return un(t) ? ((e.lastIntValue = t), e.advance(), !0) : !1;
  };
  function un(e) {
    return (
      e === 36 ||
  ...
  A.regexp_eatPatternCharacters = function (e) {
    for (var t = e.pos, i = 0; (i = e.current()) !== -1 && !un(i); )
      e.advance();
    return e.pos !== t;
  };
  ...
  A.regexp_eatControlLetter = function (e) {
    var t = e.current();
    return ln(t) ? ((e.lastIntValue = t % 32), e.advance(), !0) : !1;
  };
  function ln(e) {
  ...
  A.regexp_eatUnicodePropertyValueExpression = function (e) {
    ...
    if (this.regexp_eatUnicodePropertyName(e) && e.eat(61)) {
      ...
      if (this.regexp_eatUnicodePropertyValue(e)) {
        ...
        return (this.regexp_validateUnicodePropertyNameAndValue(e, i, r), ge);
      }
    }
  ...
  A.regexp_validateUnicodePropertyNameAndValue = function (e, t, i) {
    (je(e.unicodeProperties.nonBinary, t) || e.raise("Invalid property name"),
  ...
  A.regexp_eatUnicodePropertyName = function (e) {
    var t = 0;
    for (e.lastStringValue = ""; pn((t = e.current())); )
  ...
  A.regexp_eatCharacterClass = function (e) {
    if (e.eat(91)) {
      ...
      return (
        ...
        t && i === ce && e.raise("Negated character class may contain strings"),
        !0
      );
    }
    return !1;
  ...
  A.regexp_eatClassAtom = function (e) {
    ...
    if (e.eat(92)) {
      ...
      if (e.switchU) {
        var i = e.current();
        ((i === 99 || mn(i)) && e.raise("Invalid class escape"),
          e.raise("Invalid escape"));
      }
      e.pos = t;
    }
  ...
  A.regexp_eatHexDigits = function (e) {
    var t = e.pos,
      i = 0;
    for (e.lastIntValue = 0; fn((i = e.current())); )
      ((e.lastIntValue = 16 * e.lastIntValue + dn(i)), e.advance());
    return e.pos !== t;
  };
  function fn(e) {
    return (
  ...
  A.regexp_eatFixedHexDigits = function (e, t) {
    ...
    for (var r = 0; r < t; ++r) {
      var n = e.current();
      if (!fn(n)) return ((e.pos = i), !1);
      ((e.lastIntValue = 16 * e.lastIntValue + dn(n)), e.advance());
    }
    return !0;
  };
  var ai = function (t) {
      ((this.type = t.type),
        ...
        (this.start = t.start),
        (this.end = t.end),
        t.options.locations && (this.loc = new ht(t, t.startLoc, t.endLoc)),
  ...
  B.next = function (e) {
    (!e &&
      ...
      this.options.onToken && this.options.onToken(new ai(this)),
  ...
  B.skipBlockComment = function () {
    ...
    if (
      ...
      for (var r = void 0, n = t; (r = Br(this.input, n, this.pos)) > -1; )
    ...
    e: for (; this.pos < this.input.length; ) {
      ...
      switch (e) {
        ...
        default:
          if (
            (e > 8 && e < 14) ||
            (e >= 5760 && Fr.test(String.fromCharCode(e)))
          )
            ++this.pos;
          else break e;
      }
  ...
  B.readRegexp = function () {
    for (var e, t, i = this.pos; ; ) {
      ...
      if ((ue.test(r) && this.raise(i, "Unterminated regular expression"), e))
        e = !1;
      else {
        if (r === "[") t = !0;
        else if (r === "]" && t) t = !1;
  ...
  B.readRadixNumber = function (e) {
    ...
    return (
      ...
      this.options.ecmaVersion >= 11 && this.input.charCodeAt(this.pos) === 110
        ? ((i = yn(this.input.slice(t, this.pos))), ++this.pos)
  ...
  B.readNumber = function (e) {
    ...
    if (!i && !e && this.options.ecmaVersion >= 11 && r === 110) {
      var n = yn(this.input.slice(t, this.pos));
      return (
        ++this.pos,
        ye(this.fullCharCodeAtPos()) &&
          this.raise(this.pos, "Identifier directly after number"),
      ...
      r === 92
        ...
        : r === 8232 || r === 8233
          ? (this.options.ecmaVersion < 10 &&
            ...
            this.options.locations &&
              (this.curLine++, (this.lineStart = this.pos)))
          : (Re(r) && this.raise(this.start, "Unterminated string constant"),
            ++this.pos);
    }
    return (
      (t += this.input.slice(i, this.pos++)),
  ...
  B.tryReadTemplateToken = function () {
    ...
    try {
      ...
      if (e === gn) this.readInvalidTemplateToken();
      else throw e;
    }
    this.inTemplateElement = !1;
  };
  B.invalidStringToken = function (e, t) {
    if (this.inTemplateElement && this.options.ecmaVersion >= 9) throw gn;
    this.raise(e, t);
  };
...
`;
  ...
  function G(e, t, i, r, n, a, s) {
    return gt((t & i) | (~t & r), e, t, n, a, s);
  }
  function K(e, t, i, r, n, a, s) {
    return gt((t & r) | (i & ~r), e, t, n, a, s);
  }
  function Q(e, t, i, r, n, a, s) {
    return gt(t ^ i ^ r, e, t, n, a, s);
  }
  function Y(e, t, i, r, n, a, s) {
    return gt(i ^ (t | ~r), e, t, n, a, s);
  }
  function mt(e, t) {
  ...
  function As(e) {
    return vn(mt(ui(e), e.length * 8));
  }
  function Ls(e, t) {
    let i = ui(e),
      r = [],
      n = [];
    i.length > 16 && (i = mt(i, e.length * 8));
    for (let s = 0; s < 16; s += 1)
      ((r[s] = i[s] ^ 909522486), (n[s] = i[s] ^ 1549556828));
    let a = mt(r.concat(ui(t)), 512 + t.length * 8);
    return vn(mt(n.concat(a), 640));
  }
  function bn(e) {
  ...
  function Is(e, t, i) {
    return t ? (i ? Sn(t, e) : Rs(t, e)) : i ? wn(e) : Ps(e);
  }
  var si = 3072;
  function Ts(e) {
    let t = new Headers(e);
    if (e.has("x-bare-headers")) {
      ...
      if (i.length > si) {
        ...
        let r = 0;
        for (let n = 0; n < i.length; n += si) {
          let a = i.slice(n, n + si),
            s = r++;
  ...
  var hi = class extends ci {
        ...
        let o = new Ce(this.ws),
          ...
          h = (f) => {
            ...
            (f.stopImmediatePropagation(),
              a({ protocol: m.protocol, setCookies: m.setCookies }),
              s(ke.OPEN),
      ...
      async request(i, r, n, a, s, o, c) {
        ...
        let f = await oi(this.http + "?cache=" + Is(a.toString()), h),
          m = await this.readBareResponse(f),
          g = new _n(Cs.includes(m.status) ? void 0 : f.body, {
            status: m.status,
      ...
      async readBareResponse(i) {
        if (!i.ok) throw new yt(i.status, await i.json());
        let r = Ns(i.headers),
          n = {},
    ...
    We = class {
      ...
      demand() {
        return this.onDemand
          ? (this.working ||
              (this.working = Cn(this.server, this.onDemandSignal)
      ...
      async fetch(t, i) {
        ...
        for (let h = 0; ; h++) {
          ...
          let f = await l.request(r.method, a, o, c, r.cache, s, r.signal);
  ...
  var Pn,
    ...
    Zs = {
      Program(e, t) {
        ...
        n && e.trailingComments != null && Z(t, e.trailingComments, i, r);
      },
      BlockStatement: (Dn = function (e, t) {
        let i = t.indent.repeat(t.indentLevel++),
          { lineEnd: r, writeComments: n } = t,
          a = i + t.indent;
        t.write("{");
        ...
        if (s != null && s.length > 0) {
          (t.write(r), n && e.comments != null && Z(t, e.comments, a, r));
          let { length: o } = s;
          for (let c = 0; c < o; c++) {
            let l = s[c];
        ...
        (n && e.trailingComments != null && Z(t, e.trailingComments, a, r),
          t.write("}"),
          t.indentLevel--);
      }),
      ClassBody: Dn,
      ...
      ForStatement(e, t) {
        if ((t.write("for ("), e.init != null)) {
          let { init: i } = e;
          i.type[0] === "V" ? mi(t, i) : this[i.type](i, t);
        }
        (t.write("; "),
      ...
      ForInStatement: (Pn = function (e, t) {
      ...
      FunctionDeclaration: (Rn = function (e, t) {
        (t.write(
          (e.async ? "async " : "") +
      ...
      AwaitExpression(e, t) {
        (t.write("await ", e), vt(t, e.argument, e));
      },
      TemplateLiteral(e, t) {
      ...
      TaggedTemplateExpression(e, t) {
        (vt(t, e.tag, e), this[e.quasi.type](e.quasi, t));
      },
      ArrayExpression: (Nn = function (e, t) {
        ...
        if ((t.write("{"), e.properties.length > 0)) {
          ...
          n
            ? e.comments != null
              ? (t.write(r),
                Z(t, e.comments, a, r),
                e.trailingComments != null && Z(t, e.trailingComments, a, r),
                t.write(i + "}"))
              : e.trailingComments != null
                ? (t.write(r), Z(t, e.trailingComments, a, r), t.write(i + "}"))
                : t.write("}")
            : t.write("}");
        t.indentLevel--;
      },
      ...
      BinaryExpression: (Tn = function (e, t) {
        let i = e.operator === "in";
        (i && t.write("("),
          vt(t, e.left, e, !1),
          t.write(" " + e.operator + " "),
      ...
      NewExpression(e, t) {
        ...
        (i === pe || i < t.expressionsPrecedence.CallExpression || Js(e.callee)
    ...
    constructor(t) {
      ...
      ((this.output = ""),
        ...
        (this.expressionsPrecedence =
          i.expressionsPrecedence != null ? i.expressionsPrecedence : Ys),
...
`
  ...
  var gi = class {
      constructor(t) {
        ...
        this.path = to;
        this.acorn = { parse: xn };
        this.bare = { createBareClient: En, BareClient: We };
        this.base64 = { encode: btoa, decode: atob };
        this.estree = { generate: On };
        this.cookie = io;
        this.setCookieParser = Bn.parse;
        this.ctx = t;
      }
    },
    Fn = gi;
  function xi(e, t, i, r, n = "", a = !1, s = "") {
            ...
            attrs: [
              {
                ...
                value:
                  this.ctx.config.assets.files.inject +
                  (o ? "?" + Math.floor(Math.random() * 89999 + 1e4) : ""),
              },
            ],
          }),
        r &&
  ...
  function Ci(e, t = {}) {
    if (!(t.type == "AssignmentExpression" && t.left == e)) {
      ...
      if (e.callee.type == "MemberExpression") {
        ...
        e.callee.object.name == "eval" && bt(e);
      }
  ...
  var Pi = class {
      constructor(t) {
        ((this.ctx = t),
          ...
          (this.srcset = $n),
          (this.js = new Ke(this)),
          (this.css = new Ge(this)),
          (this.man = new Qe(this)));
      }
    },
    jn = Pi;
  async function Hn(e) {
  ...
  async function Oi(e) {
    ...
    return (
      (e.url.startsWith(location.origin + "/dynamic/dynamic.config.js") ||
        e.url.startsWith(location.origin + "/dynamic/dynamic.client.js")) &&
        (r = new Blob(
          [
            `${await r.text()}
self.document?.currentScript?.remove();`,
              ...
              (n == "text/html"
                ? (o = this.ctx.rewrite.html.rewrite(
                    ...
                    this.ctx.rewrite.html.generateHead(
                      ...
                      location.origin + "/dynamic/dynamic.config.js",
                      "",
        ...
        e.performance[t] = new Proxy(e.performance[t], {
          apply(i, r, n) {
            return Reflect.apply(i, r, n)
              .filter(
                (a) =>
                  !a.name?.includes(e.location.origin + "/dynamic/dynamic.")
              )
              .filter(
                (a) =>
                  !a.name.includes(
    ...
    if (
      ...
      e.__dynamic.define(e.document, "cookie", {
        ...
        set(t) {
          ...
          var n = sr(e.__dynamic.cookie.str || "");
          ((n[i.name] = i.value),
    ...
    function i(n) {
      if (!n.rewritten && !(n.nodeType !== 1 && n.nodeType !== 3)) {
        if (
          ...
          let o = new Blob([t.rewrite.html.rewrite(n.srcdoc, t.meta)], {
            type: "text/html",
          });
  ...
  var dr = Ae(pa(), 1),
    ya = Ae(da(), 1),
    ma = location.origin + navigator.userAgent,
    lo = {
      encode: (e, t = 2) =>
        e &&
        encodeURIComponent(
    ...
    po = {
      encode: (e) => e && dr.default.encrypt(e, ma).toString().substring(10),
      decode: (e) =>
        e && dr.default.decrypt("U2FsdGVkX1" + e, ma).toString(ya.default),
    },
  ...
  var Oe = class {
    constructor(t) {
      this.modules = new Fn(this);
      this.util = new Wn(this);
      this.meta = new zn(this);
      this.regex = new Xe(this);
      this.rewrite = new jn(this);
      this.url = new qn(this);
      this.is = new Kn(this);
      this.cookies = new tt(this);
      this.client = new et(this);
      this.encoding = mr;
      this.headers = Gn;
      this.listeners = [];
    ...
    e.__dynamic.wrap = function (t, i, r) {
      ...
      if (t.toString().includes("{ [native code] }") && !t.prototype) {
        ...
        try {
          ...
          return (
            Object.defineProperty(c, "name", { value: t.name, writable: !1 }),
            c
          );
        } catch {
          return t;
  ...
  function ga(e, t = {}, i = "") {
    ...
    let r = new Oe(e.__dynamic$config);
    ((r.config.bare.path =
  ...
  (function (e) {
    let t = new Oe(e.__dynamic$config);
    e.__dynamic = t;
