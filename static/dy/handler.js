...
(() => {
  ...
  var la = (e, t, i) =>
    t in e
      ? Je(e, t, { enumerable: !0, configurable: !0, writable: !0, value: i })
      : (e[t] = i);
  var Nt = (e, t) => () => (
    ...
    fr = (e, t) => {
      for (var i in t) Je(e, i, { get: t[i], enumerable: !0 });
    },
    ha = (e, t, i, r) => {
  ...
  var Ze = (e, t, i) => (
    ...
    ha(
      t || !e || !e.__esModule
        ? Je(i, "default", { value: e, enumerable: !0 })
        : i,
      e
    )
  );
  ...
  var Mt = Nt((go, mr) => {
    ...
    var _e = {
      ...
      isAbsolute: function (t) {
        return (te(t), t.length > 0 && t.charCodeAt(0) === 47);
      },
      join: function () {
  ...
  var Sn = Nt((ko, Ve) => {
    ...
    function vn(e, t) {
      ...
      if (
        ...
        var r = {};
        return e.filter(ci).reduce(function (n, a) {
          var s = ui(a, t);
          return ((n[s.name] = s), n);
        }, r);
      } else
        return e.filter(ci).map(function (n) {
          return ui(n, t);
        });
    }
    function Ds(e) {
    ...
    Ve.exports = vn;
    Ve.exports.parse = vn;
    Ve.exports.parseString = ui;
    Ve.exports.splitCookiesString = Ds;
  });
  var gr = Ze(Mt()),
    et = {
  ...
  function _a() {
    return (
      br ||
      (br = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])
    );
  }
  function ba() {
    return (
  ...
  function wa(e) {
    ...
    return (
      t
        .then((i) => {
          i instanceof IDBCursor && vr.set(i, e);
        })
        .catch(() => {}),
      Ft.set(t, e),
      t
  ...
  function Sa(e) {
    return e === IDBDatabase.prototype.transaction &&
      ...
      ? function (t, ...i) {
          ...
          return (Sr.set(r, t.sort ? t.sort() : [t]), G(r));
        }
      : ba().includes(e)
        ? function (...t) {
            return (e.apply(Pe(this), t), G(vr.get(this)));
          }
        : function (...t) {
            return G(e.apply(Pe(this), t));
          };
  }
  function Ea(e) {
  ...
  Er((e) => ({
    ...e,
    get: (t, i, r) => Cr(t, i) || e.get(t, i, r),
    has: (t, i) => !!Cr(t, i) || e.has(t, i),
  }));
  var La = [
  ...
  var K = { beforeExpr: !0 },
    ...
    zt = {};
  function k(e, t) {
    return (t === void 0 && (t = {}), (t.keyword = e), (zt[e] = new L(e, t)));
  }
  var u = {
      num: new L("num", H),
  ...
  function Fa(e) {
    var t = {};
    for (var i in qt) t[i] = e && Ne(e, i) ? e[i] : qt[i];
    if (
...
Defaulting to 2020, but this will stop working in the future.`)),
    ...
    return (kr(t.onComment) && (t.onComment = Ba(t, t.onComment)), t);
  }
  function Ba(e, t) {
    return function (i, r, n, a, s, o) {
      var c = { type: i ? "Block" : "Line", value: r, start: n, end: a };
      (e.locations && (c.loc = new st(this, s, o)),
  ...
  var rt = 0,
    ...
    T = function (t, i, r) {
      ...
      var n = "";
      (t.allowReserved !== !0 &&
        ((n = jt[t.ecmaVersion >= 6 ? 6 : t.ecmaVersion === 5 ? 5 : 3]),
        t.sourceType === "module" && (n += " await")),
        (this.reservedWords = pe(n)));
      var a = (n ? n + " " : "") + jt.strict;
      ((this.reservedWordsStrict = pe(a)),
        (this.reservedWordsStrictBind = pe(a + " " + jt.strictBind)),
        (this.input = String(i)),
        (this.containsEsc = !1),
        r
          ? ((this.pos = r),
...
`,
  ...
  ie.inGenerator.get = function () {
    return (
      (this.currentVarScope().flags & Or) > 0 &&
  ...
  ie.canAwait.get = function () {
    for (var e = this.scopeStack.length - 1; e >= 0; e--) {
      ...
      if (t.flags & ve) return (t.flags & Kt) > 0;
    }
    return (
  ...
  ie.allowSuper.get = function () {
    ...
    return (t & Xt) > 0 || i || this.options.allowSuperOutsideMethod;
  };
  ie.allowDirectSuper.get = function () {
    return (this.currentThisScope().flags & Br) > 0;
  };
  ...
  w.parseFunctionStatement = function (e, t, i) {
    return (this.next(), this.parseFunction(e, Re | (i ? 0 : Gt), !1, t));
  };
  ...
  w.parseCatchClauseParam = function () {
    var e = this.parseBindingAtom(),
      t = e.type === "Identifier";
    return (
      this.enterScope(t ? Fr : 0),
      this.checkLValPattern(e, t ? jr : le),
  ...
  w.parseVarId = function (e, t) {
    ((e.id = this.parseBindingAtom()),
      this.checkLValPattern(e.id, t === "var" ? Jt : le, !1));
  };
  var Re = 1,
    Gt = 2,
    Hr = 4;
  w.parseFunction = function (e, t, i, r, n) {
    (this.initFunction(e),
      (this.options.ecmaVersion >= 9 ||
        ...
        (this.type === u.star && t & Gt && this.unexpected(),
        (e.generator = this.eat(u.star))),
      this.options.ecmaVersion >= 8 && (e.async = !!r),
      t & Re &&
        ((e.id = t & Hr && this.type !== u.name ? null : this.parseIdent()),
        e.id &&
          !(t & Gt) &&
  ...
  w.parseClassElement = function (e) {
    ...
    if (
      ...
      var l = !i.static && nt(i, "constructor"),
        h = l && e;
      (l &&
        s !== "method" &&
  ...
  w.parseClassStaticBlock = function (e) {
    e.body = [];
    var t = this.labels;
    for (this.labels = [], this.enterScope(Me | Xt); this.type !== u.braceR; ) {
  ...
  w.parseExportDefaultDeclaration = function () {
    ...
    if (this.type === u._function || (e = this.isAsyncFunction())) {
      ...
      return (
        this.next(),
        e && this.next(),
        this.parseFunction(t, Re | Hr, !1, e)
      );
  ...
  w.checkExport = function (e, t, i) {
    e &&
      ...
      Ne(e, t) && this.raiseRecoverable(i, "Duplicate export '" + t + "'"),
      (e[t] = !0));
  };
        ...
        (this.strict &&
          ...
          r &&
            ...
            i &&
              ...
              (i[e.name] = !0)),
            t !== Ur && this.declareName(e.name, t, e.start)));
        break;
      case "ChainExpression":
        this.raiseRecoverable(
          e.start,
      ...
      ((o.operator = this.value),
        ...
        c
          ...
          : this.strict &&
            ...
            : o.operator === "delete" && Wr(o.argument)
              ? this.raiseRecoverable(
                  o.start,
  ...
  function Wr(e) {
    return (
      ...
      (e.type === "ChainExpression" && Wr(e.expression))
    );
  }
  ...
  v.parseParenAndDistinguishExpression = function (e, t) {
    ...
    if (this.options.preserveParens) {
      ...
      return (
        (se.expression = n),
        this.finishNode(se, "ParenthesizedExpression")
      );
    } else return n;
  };
...
`
  ...
  v.parseMethod = function (e, t, i) {
    ...
    return (
      ...
      (this.awaitPos = 0),
      (this.awaitIdentPos = 0),
      this.enterScope(Yt(t, r.generator) | Xt | (i ? Br : 0)),
      this.expect(u.parenL),
  ...
  v.parseFunctionBody = function (e, t, i, r) {
    ...
    if (n)
      ...
      ((this.labels = []),
        ...
        this.strict && e.id && this.checkLValSimple(e.id, Ur),
  ...
  v.checkParams = function (e, t) {
    for (
      ...
      var a = n[r];
      this.checkLValInnerPattern(a, Jt, t ? null : i);
    }
  };
  ...
  de.treatFunctionsAsVarInScope = function (e) {
    return e.flags & ve || (!this.inModule && e.flags & Te);
  };
  de.declareName = function (e, t, i) {
    ...
    if (t === le) {
      ...
      ((r =
        ...
        n.var.indexOf(e) > -1),
        n.lexical.push(e),
        this.inModule && n.flags & Te && delete this.undefinedExports[e]);
    } else if (t === jr) {
      ...
      for (var o = this.scopeStack.length - 1; o >= 0; --o) {
        ...
        if (
          (c.var.push(e),
          this.inModule && c.flags & Te && delete this.undefinedExports[e],
          c.flags & Qt)
        )
          break;
      }
  ...
  de.currentThisScope = function () {
    for (var e = this.scopeStack.length - 1; ; e--) {
      var t = this.scopeStack[e];
      if (t.flags & Qt && !(t.flags & Vr)) return t;
    }
  };
  var ct = function (t, i, r) {
      ((this.type = ""),
        (this.start = i),
        (this.end = 0),
        t.options.locations && (this.loc = new st(t, r)),
  ...
  var Gr =
    ...
    zr = Gr + " Extended_Pictographic",
    Kr = zr,
    Xr = Kr + " EBase EComp EMod EPres ExtPict",
    Qr = Xr,
    Ga = Qr,
    za = { 9: Gr, 10: zr, 11: Kr, 12: Xr, 13: Qr, 14: Ga },
    Ka =
    ...
    tn =
      en + " Cypro_Minoan Cpmn Old_Uyghur Ougr Tangsa Tnsa Toto Vithkuqi Vith",
    Qa = tn + " Hrkt Katakana_Or_Hiragana Kawi Nag_Mundari Nagm Unknown Zzzz",
    Ya = { 9: Yr, 10: Jr, 11: Zr, 12: en, 13: tn, 14: Qa },
    rn = {};
  function Ja(e) {
    var t = (rn[e] = {
      binary: pe(za[e] + " " + Lr),
      binaryOfStrings: pe(Xa[e]),
      nonBinary: { General_Category: pe(Lr), Script: pe(Ya[e]) },
    });
  ...
  for (it = 0, Ht = [9, 10, 11, 12, 13, 14]; it < Ht.length; it += 1)
    ((Pr = Ht[it]), Ja(Pr));
  var Pr,
    it,
    Ht,
    ...
    re = function (t) {
      ((this.parser = t),
        ...
        (this.unicodeProperties =
          rn[t.options.ecmaVersion >= 14 ? 14 : t.options.ecmaVersion]),
        (this.source = ""),
        (this.flags = ""),
        (this.start = 0),
        (this.switchU = !1),
  ...
  b.regexp_eatSyntaxCharacter = function (e) {
    var t = e.current();
    return nn(t) ? ((e.lastIntValue = t), e.advance(), !0) : !1;
  };
  function nn(e) {
    return (
      e === 36 ||
  ...
  b.regexp_eatPatternCharacters = function (e) {
    for (var t = e.pos, i = 0; (i = e.current()) !== -1 && !nn(i); )
      e.advance();
    return e.pos !== t;
  };
  ...
  b.regexp_validateUnicodePropertyNameAndValue = function (e, t, i) {
    (Ne(e.unicodeProperties.nonBinary, t) || e.raise("Invalid property name"),
  ...
  b.regexp_eatClassAtom = function (e) {
    ...
    if (e.eat(92)) {
      ...
      if (e.switchU) {
        var i = e.current();
        ((i === 99 || ln(i)) && e.raise("Invalid class escape"),
          e.raise("Invalid escape"));
      }
      e.pos = t;
    }
  ...
  b.regexp_eatDecimalDigits = function (e) {
    var t = e.pos,
      i = 0;
    for (e.lastIntValue = 0; ut((i = e.current())); )
  ...
  b.regexp_eatHexDigits = function (e) {
    var t = e.pos,
      i = 0;
    for (e.lastIntValue = 0; cn((i = e.current())); )
      ((e.lastIntValue = 16 * e.lastIntValue + un(i)), e.advance());
    return e.pos !== t;
  };
  function cn(e) {
    return (
  ...
  b.regexp_eatFixedHexDigits = function (e, t) {
    ...
    for (var r = 0; r < t; ++r) {
      var n = e.current();
      if (!cn(n)) return ((e.pos = i), !1);
      ((e.lastIntValue = 16 * e.lastIntValue + un(n)), e.advance());
    }
    return !0;
  };
  var ei = function (t) {
      ((this.type = t.type),
        ...
        (this.start = t.start),
        (this.end = t.end),
        t.options.locations && (this.loc = new st(t, t.startLoc, t.endLoc)),
  ...
  C.next = function (e) {
    (!e &&
      ...
      this.options.onToken && this.options.onToken(new ei(this)),
  ...
  C.readRadixNumber = function (e) {
    ...
    return (
      ...
      this.options.ecmaVersion >= 11 && this.input.charCodeAt(this.pos) === 110
        ? ((i = hn(this.input.slice(t, this.pos))), ++this.pos)
  ...
  C.readNumber = function (e) {
    ...
    if (!i && !e && this.options.ecmaVersion >= 11 && r === 110) {
      var n = hn(this.input.slice(t, this.pos));
      return (
        ++this.pos,
        ce(this.fullCharCodeAtPos()) &&
          this.raise(this.pos, "Identifier directly after number"),
...
`;
  ...
  var ii = globalThis.fetch,
    me = globalThis.WebSocket,
    us = globalThis.Request,
    dn = globalThis.Response,
    ge = {
  ...
  function ds(e) {
    return mn(lt(ni(e), e.length * 8));
  }
  function ms(e, t) {
    let i = ni(e),
      r = [],
      n = [];
    i.length > 16 && (i = lt(i, e.length * 8));
    for (let s = 0; s < 16; s += 1)
      ((r[s] = i[s] ^ 909522486), (n[s] = i[s] ^ 1549556828));
    let a = lt(r.concat(ni(t)), 512 + t.length * 8);
    return mn(lt(n.concat(a), 512 + 128));
  }
  function yn(e) {
  ...
  function xs(e, t, i) {
    return t ? (i ? xn(t, e) : gs(t, e)) : i ? gn(e) : ys(e);
  }
  var ti = 3072;
  function _s(e) {
    let t = new Headers(e);
    if (e.has("x-bare-headers")) {
      ...
      if (i.length > ti) {
        ...
        let r = 0;
        for (let n = 0; n < i.length; n += ti) {
          let a = i.slice(n, n + ti),
            s = r++;
  ...
  var si = class extends ri {
      ...
      async request(i, r, n, a, s, o, c) {
        ...
        let l = {};
        if (r instanceof Headers) for (let [p, W] of r) l[p] = W;
        else for (let p in r) l[p] = r[p];
        let h = { credentials: "omit", method: i, signal: c };
        (s !== "only-if-cached" && (h.cache = s),
          n !== void 0 && (h.body = n),
          o !== void 0 && (h.duplex = o),
          (h.headers = this.createBareHeaders(a, l)));
        let f = await ii(this.http + "?cache=" + xs(a.toString()), h),
          A = await this.readBareResponse(f),
          d = new dn(hs.includes(A.status) ? void 0 : f.body, {
            status: A.status,
      ...
      async readBareResponse(i) {
        if (!i.ok) throw new ht(i.status, await i.json());
        let r = bs(i.headers),
          n = {},
    ...
    Oe = class {
      ...
      demand() {
        return this.onDemand
          ? (this.working ||
              (this.working = _n(this.server, this.onDemandSignal)
...
`,
  ...
  var En,
    ...
    $s = {
      ...
      BlockStatement: (Pn = function (e, t) {
        let i = t.indent.repeat(t.indentLevel++),
          { lineEnd: r, writeComments: n } = t,
          a = i + t.indent;
        t.write("{");
      ...
      ForStatement(e, t) {
        if ((t.write("for ("), e.init != null)) {
          let { init: i } = e;
          i.type[0] === "V" ? li(t, i) : this[i.type](i, t);
        }
        (t.write("; "),
      ...
      ForInStatement: (En = function (e, t) {
      ...
      FunctionDeclaration: (Cn = function (e, t) {
        (t.write(
          (e.async ? "async " : "") +
      ...
      AwaitExpression(e, t) {
        (t.write("await ", e), mt(t, e.argument, e));
      },
      TemplateLiteral(e, t) {
      ...
      TaggedTemplateExpression(e, t) {
        (mt(t, e.tag, e), this[e.quasi.type](e.quasi, t));
      },
      ArrayExpression: (Ln = function (e, t) {
      ...
      BinaryExpression: (An = function (e, t) {
        let i = e.operator === "in";
        (i && t.write("("),
          mt(t, e.left, e, !1),
          t.write(" " + e.operator + " "),
...
`
  ...
  var pi = class {
      constructor(t) {
        ...
        this.path = Us;
        this.acorn = { parse: fn };
        this.bare = { createBareClient: bn, BareClient: Oe };
        this.base64 = { encode: btoa, decode: atob };
        this.estree = { generate: In };
        this.cookie = Hs;
        this.setCookieParser = Tn.parse;
        this.ctx = t;
      }
    },
    Nn = pi;
  function fi(e, t, i, r, n = "", a = !1, s = "") {
  ...
  function _i(e, t = {}) {
    if (!(t.type == "AssignmentExpression" && t.left == e)) {
      ...
      if (e.callee.type == "MemberExpression") {
        ...
        e.callee.object.name == "eval" && yt(e);
      }
...
${t}`;
      ...
      return (
        r &&
          (t = `
      if (typeof self !== undefined && typeof self.importScripts == 'function' && typeof self.__dynamic == 'undefined') importScripts('/dy/config.js?v=4', '/dy/handler.js?v=4'+Math.floor(Math.random()*(99999-10000)+10000));
  ...
  async function Ii(e) {
    ...
    let r = await t.blob();
    return (
      (e.url.startsWith(location.origin + "/dy/config.js?v=3") ||
              ...
              (n == "text/html"
                ? (o = this.ctx.rewrite.html.rewrite(
                    ...
                    this.ctx.rewrite.html.generateHead(
                      ...
                      location.origin + "/dy/config.js?v=3",
                      "",
        ...
        e.performance[t] = new Proxy(e.performance[t], {
          apply(i, r, n) {
            return Reflect.apply(i, r, n)
              .filter(
                (a) => !a.name?.includes(e.location.origin + "/dy/dynamic.")
              )
              .filter(
                (a) =>
                  !a.name.includes(
    ...
    if (
      ...
      e.__dynamic.define(e.document, "cookie", {
        ...
        set(t) {
          ...
          var n = tr(e.__dynamic.cookie.str || "");
          ((n[i.name] = i.value),
  ...
  var eo = function (e) {
    ...
    Qn = function (e, t) {
      var i = xe >= 12 ? 3 : 2,
        ...
        o = e.concat(t),
        c;
      for (a[0] = Xn(o), s = a[0], c = 1; c < i; c++)
        ((a[c] = Xn(a[c - 1].concat(o))), (s = s.concat(a[c])));
      return (
        (r = s.slice(0, 4 * ne)),
    ...
    io = function (e, t, i, r) {
      ...
      for (s = a.length - 1; s >= 0; s--)
        ((o[s] = no(a[s], t)),
          (o[s] = s === 0 ? Tt(o[s], i) : Tt(o[s], a[s - 1])));
      for (s = 0; s < n - 1; s++) c += zn(o[s], !1);
      return ((c += zn(o[s], !0)), r ? c : Js(c));
    },
    ro = function (e, t) {
      Ke = !1;
      var i = It(e, t, 0),
        r;
      for (r = 1; r < xe + 1; r++)
        ((i = Yn(i)), (i = Jn(i)), r < xe && (i = Zn(i)), (i = It(i, t, r)));
      return i;
    },
    no = function (e, t) {
      Ke = !0;
      var i = It(e, t, xe),
        r;
      for (r = xe - 1; r > -1; r--)
        ((i = Jn(i)), (i = Yn(i)), (i = It(i, t, r)), r > 0 && (i = Zn(i)));
      return i;
    },
    Yn = function (e) {
      var t = Ke ? co : lr,
    ...
    Zn = function (e) {
      ...
      if (Ke)
        ...
        for (i = 0; i < 4; i++)
          ((t[i * 4] =
            Ct[e[i * 4]] ^ kt[e[1 + i * 4]] ^ e[2 + i * 4] ^ e[3 + i * 4]),
            (t[1 + i * 4] =
              e[i * 4] ^ Ct[e[1 + i * 4]] ^ kt[e[2 + i * 4]] ^ e[3 + i * 4]),
            (t[2 + i * 4] =
              e[i * 4] ^ e[1 + i * 4] ^ Ct[e[2 + i * 4]] ^ kt[e[3 + i * 4]]),
            (t[3 + i * 4] =
              kt[e[i * 4]] ^ e[1 + i * 4] ^ e[2 + i * 4] ^ Ct[e[3 + i * 4]]));
      return t;
    },
    It = function (e, t, i) {
      var r = [],
    ...
    ea = function (e) {
      var t = [],
        ...
        o;
      for (r = 0; r < ne; r++)
        ((n = [e[4 * r], e[4 * r + 1], e[4 * r + 2], e[4 * r + 3]]),
          (t[r] = n));
      for (r = ne; r < 4 * (xe + 1); r++) {
        for (t[r] = [], a = 0; a < 4; a++) i[a] = t[r - 1][a];
        for (
          r % ne === 0
            ? ((i = Kn(ao(i))), (i[0] ^= uo[r / ne - 1]))
            : ne > 6 && r % ne === 4 && (i = Kn(i)),
            a = 0;
          a < 4;
          a++
    ...
    co = so(lr),
    uo = ur("01020408102040801b366cd8ab4d9a2f5ebc63c697356ad4b37dfaefc591", 2),
    Ct = Ae(2),
    kt = Ae(3),
    At = Ae(9),
    Lt = Ae(11),
...
`);
    ...
    return (
      typeof Array.indexOf == "function" && (e = t),
      { encode: i, decode: r }
    );
  })();
  var lo = {
    ...
    po = {
      encode: (e) => e && encodeURIComponent(ta(e, "dynamic").substring(10)),
      decode: (e) => e && ia("U2FsdGVkX1" + decodeURIComponent(e), "dynamic"),
    },
  ...
  var Le = class {
    constructor(t) {
      this.modules = new Nn(this);
      this.util = new Bn(this);
      this.meta = new jn(this);
      this.regex = new He(this);
      this.rewrite = new On(this);
      this.url = new $n(this);
      this.is = new Hn(this);
