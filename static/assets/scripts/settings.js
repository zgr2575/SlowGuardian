...
function AB() {
  ...
  if (!inFrame && !navigator.userAgent.includes("Firefox")) {
    ...
    if (!popup || popup.closed) {
      alert(
        "Please allow popups and redirects. If you dont and you get the site blocked your getting IP banned",
      );
    } else {
...
function toggleAB() {
  ...
  if (ab == null) {
    localStorage.setItem("ab", "true"); // On by defualt (Harder to block.)
  } else if (ab == "true") {
