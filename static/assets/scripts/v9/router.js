    ...
    element.innerHTML = `
      ...
      <div class="card-content">
        <div class="app-categories">
          ${app.categories ? app.categories.map(cat => 
  ...
  createGameElement(game) {
    ...
    element.innerHTML = `
      ...
      <div class="card-content">
        ...
        ${game.error ? `<div class="alert alert-error">
          <div class="alert-icon">⚠️</div>
          <div class="alert-content">${game.say || 'This game is currently unavailable'}</div>
        </div>` : ''}
        ${game.partial ? `<div class="alert alert-warning">
          <div class="alert-icon">⚠️</div>
...
export { router, PageController, HomeController, AppsController, GamesController, SettingsController };