...
class ParticleSystem {
  ...
  createParticle() {
    const particle = {
      ...
      y: random.float(this.container.offsetHeight, this.container.offsetHeight + 100),
...
class ConstellationSystem {
      ...
      for (let j = i + 1; j < this.particles.length; j++) {
        ...
        if (distance < this.connectionDistance) {
          this.connections.push({
            p1, p2, distance,
            opacity: (this.connectionDistance - distance) / this.connectionDistance * 0.3
          });
        }
      }
    }
  ...
  draw() {
    ...
    this.connections.forEach(connection => {
      ...
      line.setAttribute('stroke', 'rgba(79, 70, 229, ' + connection.opacity + ')');
    ...
    this.particles.forEach(particle => {
      ...
      circle.setAttribute('fill', 'rgba(255, 255, 255, ' + particle.opacity + ')');
