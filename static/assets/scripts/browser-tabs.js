...
class BrowserTabs {
  ...
  setupEventListeners() {
    ...
    document
      .getElementById("new-tab-quick-btn")
      ?.addEventListener("click", () => this.createNewTab());
    document
      .getElementById("close-all-tabs-btn")
      ?.addEventListener("click", () => this.closeAllTabs());
    document
      .getElementById("duplicate-tab-btn")
      ?.addEventListener("click", () => this.duplicateCurrentTab());

    // Session management
    document
      .getElementById("save-session-btn")
      ?.addEventListener("click", () => this.showSaveSessionModal());
    document
      .getElementById("restore-session-btn")
      ?.addEventListener("click", () => this.showRestoreSessionModal());
    ...
    document
      ...
      ?.addEventListener("click", () => this.refreshCurrentTab());
    document
    ...
    document
      ...
      ?.addEventListener("click", () => this.bookmarkCurrentPage());
    document
      .getElementById("share-btn")
      ?.addEventListener("click", () => this.shareCurrentPage());
    document
      .getElementById("menu-btn")
      ?.addEventListener("click", () => this.showPageMenu());
  ...
  closeOtherTabs(keepTabId) {
    const tabsToClose = Array.from(this.tabs.keys()).filter(
      (id) => id !== keepTabId
    );
